...
Window {
    ...
    CaptureSession {
        ...
        camera: Camera {
            id: camera
            active: true // Automatically turn on the camera
    ...
    Row {
        ...
        Button {        // Simulate Sonic sensor being triggered
            text: "Sensor"
            width: 150
            height: 50
            ...
            onClicked: {
                console.log("Sensor button clicked, capturing image...");
                imageCapture.captureToFile("D:/QT Projects/SmartBirdFeeder_1/images/CapturedImage.jpg"); // Absolute path, either switch to dynamic OR just remove saving the OG Captured image, not really needed as we can just send the captured image to the API
                //console.log("Image capture triggered for path:", Qt.resolvedUrl("images/CapturedImage.jpg"));
